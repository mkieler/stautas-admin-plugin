( function( $ ) {
	...
	$(document).ready(function () {
		$('#settings-form').submit(ajaxSubmit);
	...
	function success(){
		...
		$("#post-status-message #status-info p").html("Indstillingerne blev opdateret");
	...
	function error(){
		...
		$("#post-status-message #status-info p").html("Indstillingerne blev ikke opdateret");
